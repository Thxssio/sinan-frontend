...
const patientSection = {
    ...
    fields: [
        ...
        },
        {
            ...
            label: "Estado",
            kind: "text",
            schema: z.string().min(2, "Estado obrigatório"),
            defaultValue: "",
        },
    ],
...
const transmissionSourceSection = {
    ...
    title: "Fonte de Transmissão",
    description: "Informações sobre a fonte de transmissão do botulismo.",
    columns: 3,
    fields: [
        {
...
const treatmentSection = {
    id: "treatment",
    title: "Tratamento",
    description: "Informações sobre o tratamento do paciente.",
    columns: 3,
    fields: [
        {
